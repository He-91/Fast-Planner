...
> **🔧 Compilation Fixes Available**: This fork includes fixes for GCC 5+ compilation issues and mockamap simulation integration. See [COMPILATION_FIXES.md](COMPILATION_FIXES.md) for details.
